...
const Contact = () => {
  return (
    <div className="relative w-full h-screen flex items-center justify-center overflow-hidden bg-gray-50">
      ...
      <div className="relative z-10 backdrop-blur-sm bg-white/95 border border-gray-200/50 rounded-2xl shadow-xl p-5 w-full max-w-md mx-4 transition-all duration-300 hover:shadow-2xl hover:bg-white/98">
        {/* Subtle top accent line */}
        <div className="w-16 h-0.5 bg-gradient-to-r from-gray-400 to-gray-600 mx-auto mb-8"></div>
        
        <h2 className="text-gray-800 text-2xl mb-2 font-light tracking-wide text-center">
          Get In Touch
        </h2>
        <p className="leading-relaxed mb-8 text-gray-500 text-center font-light text-sm tracking-wide">
          Let's connect and create something meaningful together
        </p>

        <div className="space-y-6">
          <div className="group text-center">
            <p className="text-gray-600 text-sm font-medium mb-1 tracking-wide uppercase opacity-70">
              Email
            </p>
            <a 
              href="mailto:abhinava808@gmail.com" 
              className="text-gray-800 hover:text-gray-600 transition-colors duration-200 text-lg font-light tracking-wide block"
            >
